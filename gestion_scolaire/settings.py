...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-gmti56ech(i%4)@=uc@!#u6zb55@hr6j%5vdn@h=)v^q%*2)47"
)
...
# Connexion MongoDB
try:
    mongoengine.connect(host=MONGODB_URI, alias="default", db="gestion_scolaire_db")
...
SPECTACULAR_SETTINGS = {
    ...
    "SECURITY_DEFINITIONS": {
        "TokenAuth": {
            ...
            "in": "header",
            "name": "Authorization",
            "description": 'Bearer token authentication with required prefix "Bearer"',
        }
    },
}
